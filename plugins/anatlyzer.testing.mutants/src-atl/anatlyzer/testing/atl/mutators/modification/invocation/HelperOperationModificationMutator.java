package anatlyzer.testing.atl.mutators.modification.invocation;
...
public class HelperOperationModificationMutator extends AbstractInvocationModificationMutator {
	...
	public void generateMutants(ATLModel wrapper, MuMetaModel inputMM, MuMetaModel outputMM) {
		...
		// generate mutants
		this.genericAttributeModification(wrapper, OperationCallExp.class, "operationName", outputMM, true);
		this.genericAttributeModification(wrapper, NavigationOrAttributeCallExp.class, "name", outputMM, true);
	}
